...
<template>
    <div class="h-[50vh]" v-if="poolList">
        <div v-for="pool in poolList"
            ...
            @click="selectedPool = pool; $emit('selectedPool', pool)">
            <div class="w-full">
                <div class="flex">
                    <div class="shrink-0">
                        <div class="-rotate-[11deg] h-20 w-20 bg-blue-900 rounded">
                            <img class="-rotate-[12deg] h-20 w-20 object-cover rounded shadow"
                    ...
                    <div class="px-6 py-4 w-full">
                        <div class="capitalize text-sm tracking-wide font-semibold">{{ pool.swimmingPoolName }}</div>
